...
local strings  = {
	...
	DAS_MENU_TB_QSTEO		= "Вставка «Either of»",
	DAS_MENU_TB_QSTEO_TIP	= "Если заданий в рекламе больше 1, DAS вставит этот кусок перед списком кодов. Сотрите или замените при необходимости.",

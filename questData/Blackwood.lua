...
table.insert(tbl2, {[1] = "ritual", [2] = "Sul-Xan"})
...
table.insert(tbl2, {[1] = "ruinark", [2] = "xanmeer"})
table.insert(tbl, GetString(DAS_BLACKWD_LAGOON))
table.insert(tbl2, {[1] = "lagoon",[2] = "xeemhok"})

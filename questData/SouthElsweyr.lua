...
-- Senchal dailies prerequisite
prequestId = 6420
prequestName = GetQuestName(prequestId) -- In Defense of Pellitine
DAS.prequests[GetString(DAS_SE_RICE)] = {
	prequestName = prequestName,
	prequestId   = prequestId,
}
DAS.prequests[GetString(DAS_SE_PARIAH)] = {
	prequestName = prequestName,
	prequestId   = prequestId,
}
DAS.prequests[GetString(DAS_SE_HEAL)] = {
	prequestName = prequestName,
	prequestId   = prequestId,
}
DAS.prequests[GetString(DAS_SE_DUST)] = {
	prequestName = prequestName,
	prequestId   = prequestId,
}
DAS.prequests[GetString(DAS_SE_FLETCH)] = {
	prequestName = prequestName,
	prequestId   = prequestId,
}
DAS.prequests[GetString(DAS_SE_SCHOL)] = {
	prequestName = prequestName,
	prequestId   = prequestId,
}
DAS.prequests[GetString(DAS_SE_CANDLE)] = {
	prequestName = prequestName,
	prequestId   = prequestId,
}
DAS.prequests[GetString(DAS_SE_SWORD)] = {
	prequestName = prequestName,
	prequestId   = prequestId,
}
DAS.prequests[GetString(DAS_SE_LILY)] = {
	prequestName = prequestName,
	prequestId   = prequestId,
}
DAS.prequests[GetString(DAS_SE_BLOOD)] = {
	prequestName = prequestName,
	prequestId   = prequestId,
}
DAS.prequests[GetString(DAS_SE_TOMES)] = {
	prequestName = prequestName,
	prequestId   = prequestId,
}
DAS.prequests[GetString(DAS_SE_MUSH)] = {
	prequestName = prequestName,
	prequestId   = prequestId,
}